...
DoomPicture::DoomPicture(uint16_t width, uint16_t height, int16_t leftOffset, int16_t topOffset, std::shared_ptr<uint8_t[]> pixels): width(width), height(height), leftOffset(leftOffset), topOffset(topOffset), pixels(pixels) {}

std::ostream &operator<<(std::ostream &os, const DoomPicture &obj) { 
